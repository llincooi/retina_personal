function makeOLED_checkerboard_video(WherenWhen, refresh_fps, num_pixel, mins, bright_lum, aperture)
...
monitor_mean_lumin = interp1(real_lum*aperture,lum,bright_lum/2,'linear');
...
T = dt:dt:T;
%% Video name
name=[WherenWhen.date,'_Checkerboard_A=',num2str(aperture),'_',int2str(refresh_fps),'Hz_',int2str(num_pixel),'_',int2str(mins),'min_Br50_Q100'];
name
...
monitor_bright_lumin= interp1(real_lum*aperture,lum,bright_lum,'linear');
