...
load('D:\Leo\0229\data\0224_Gollish_OnOff_movie_5min_Br50_Q100_6.5mW_2.mat')
%% For unsorted spikes
sorted = 0;
%% For sorted spikes
% load('sort\0421_Gollish_OnOff_movie_5min_Br50_Q100_0.5.mat')
% sorted = 1;
% unit = 0;
...
name = '0224_Gollish_OnOff_6.5_2';%Name that used to save photo and data
num_cycle =10;
