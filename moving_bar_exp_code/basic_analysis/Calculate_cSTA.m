...
if XOsave
    if sorted
        saveas(gcf,[exp_folder,'\FIG\cSTA\sort\', 'dcsta_',name,'.tiff'])
    else
        saveas(gcf,[exp_folder,'\FIG\cSTA\unsort\', 'dcsta_',name,'.tiff'])
    end
end
...
if XOsave
    if sorted
        ...
        saveas(gcf,[exp_folder,'\FIG\cSTA\sort\', name,'on_off_index.tiff'])
    else
        saveas(gcf,[exp_folder,'\FIG\cSTA\unsort\', name,'on_off_index.tiff'])
