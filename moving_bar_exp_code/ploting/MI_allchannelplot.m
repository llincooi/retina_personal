...
%     if sorted
%         save([exp_folder,'\MI\sort\',filename],'time','Mutual_infos','Mutual_shuffle_infos','P_channel','N_channel','peak_times', 'MI_peak', 'corr_time')
%     else
%         save([exp_folder,'\MI\unsort\',filename],'time','Mutual_infos','Mutual_shuffle_infos','P_channel','N_channel','peak_times', 'MI_peak', 'corr_time')
%     end
    close(gcf)
end
